...
from wtforms import StringField, PasswordField, BooleanField, SubmitField, DateTimeField, DateField, IntegerField, \
    FloatField, SelectField
from wtforms.validators import DataRequired, Email, EqualTo, Optional, AnyOf
